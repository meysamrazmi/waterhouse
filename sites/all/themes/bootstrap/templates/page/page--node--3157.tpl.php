 ...
 * @ingroup templates
 */
drupal_add_css(drupal_get_path('theme', 'bootstrap') . '/css/lib/owl.carousel.min.css');
drupal_add_css(drupal_get_path('theme', 'bootstrap') . '/css/lib/owl.theme.default.min.css');
?>
...
<div class="main-container <?php print $container_class; ?>">
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <h1 class="store-title">جدیدترین دوره ها</h1>
      <span class="bg-text" style="top: 50px;right: -60px;">جدیدترین دوره ها</span>
      <?php print views_embed_view('products', 'block');?>
